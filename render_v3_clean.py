...
def render_views():
    ...
    setup_axes(ax2, (10, 140), (-32, 32), (-5, 35), 28, -60,
               "2. С левого борта от носа: планширь по борту и опущенный бак, сплошная скруглённая\nпередняя стенка рубки под 25° с акриловым люком, окно почти во всю стенку", zoom=1.25)
