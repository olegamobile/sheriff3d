...
def render_views():
    ...
    views = [
        ...
        ([(wl, boat_c)], 28, -60,
         ...
         "(дуга сверху и на палубе) со скатом 32° и акриловым люком, окно заходит на крышу"),
        ([(wl, boat_c), (rudder, rudder_c)], 36, -125,
         "3. С левой раковины: планширь, банки и пол до транца, полукруглые плечи,\n"
         "плоская переборка под 30° с большим входом, канавки-проходы на крыше, румпель над транцем"),
