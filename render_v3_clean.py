...
def render_views():
    ...
    views = [
        ([(wl, boat_c)], 88, -90,
         "1. План палубы: утопленный бак с релингом и уткой, скруглённая рубка с гнутым люком, ступенчатые террасы-проходы,\n"
         "банки с крышкой рундука, кормовая площадка, чистый пол кокпита"),
        ([(wl, boat_c)], 28, -60,
         "2. С левого борта от носа: носовой релинг, опущенный бак, полукруглый нос рубки со скатом 32°,\n"
         "акриловый люк без рамки (заходит на 5 см на крышу), терраса-ступенька"),
        ([(wl, boat_c), (rudder, rudder_c)], 36, -125,
         "3. С левой раковины: банки, крышка рундука на правом борту, кормовая площадка перед транцем,\n"
         "чистый пол, плоская переборка под 30°, скруглённые плечи комингсов"),
        ([(full, boat_c), (rudder, rudder_c), (cradle, cradle_c)], 0, -90,
         "4. Профиль: обводы Филиппа Арле, низкая рубка со ступенью, релинг, чугунный фальшкиль, кильблок"),
    ]
