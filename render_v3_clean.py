...
def render_views():
    ...
    setup_axes(ax1, (0, 140), (-32, 32), (-5, 35), 88, -90,
               "1. План палубы: бак с бортиками и поперечной уткой, скруглённая рубка с люком и окнами,\nбанки до транца с полукруглыми плечами у переборки, стойки с упором для ног и балка оттяжки", zoom=1.25)
    ...
    setup_axes(ax2, (10, 140), (-32, 32), (-5, 35), 28, -60,
               "2. С левого борта от носа: бак с низкими бортиками, скруглённый в плане скат рубки 25°\nс акриловым люком, трапециевидное окно почти во всю стенку, мачта на краю крыши", zoom=1.25)
    ...
    setup_axes(ax3, (-15, 115), (-32, 32), (-5, 35), 36, -125,
               "3. С левой раковины: полоса планширя, банки и пол до транца, полукруглые плечи\nу переборки, наклонённая переборка с дверью, румпель над транцем", zoom=1.25)
