...
def render_views():
    ...
    setup_axes(ax1, (0, 140), (-32, 32), (-5, 35), 88, -90,
               "1. План палубы: утопленный бак с уткой, скруглённая рубка с люком, окнами и проходами,\nбанки до транца с полукруглыми плечами, доска-упор для ног и балка оттяжки", zoom=1.25)
    ...
    setup_axes(ax2, (10, 140), (-32, 32), (-5, 35), 28, -60,
               "2. С левого борта от носа: планширь по борту и опущенный бак, скруглённый нос рубки\n(дуга сверху и на палубе) со скатом 32° и акриловым люком, окно почти во всю стенку", zoom=1.25)
